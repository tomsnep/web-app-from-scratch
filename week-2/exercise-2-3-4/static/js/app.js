...
(function() {
	...
	var detailView = {
			...
			aja()
			   ...
			   .on('success', function(data) {	
                    ...
                    if(detailData.type == 'video'){
                    	console.log('video type is true');
                    	detailView.checkVideo(detailData);
                    } else {
                    	console.log('video type is false')
		...
		checkVideo: function(detailData) {
			...
			console.log('checkVideo() was fired');
		...
		renderVideo: function(detailData) {
			...
			console.log('renderVideo is fired')
			// create directives
			var directives = {
                ...
                photoVideo: {
					src: function(params) {
						console.log(this.videos.standard_resolution.url);
		...
		renderPhoto: function(detailData) {
			...
			console.log('renderPhoto is fired');
			// make var video to check if there is a video element in the dom
			var video = document.querySelector('video');

			// check if video exists. If so, remove the element
			if (typeof(video) != 'undefined' && video != null){
				  video.remove();
				  console.log('video el is removed')
			}; 
